...
@router.get('/xlsx')
def get_xlsx():
    return FileResponse('xlsx.xlsx', media_type='application/vnd.openxmlformats-officedocument.spreadsheetml.sheet', headers={'Content-Disposition': 'attachment; filename="Book.xlsx"'})
